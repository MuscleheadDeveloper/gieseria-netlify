          ...
          <div className="w-full px-4">
            ...
            <div className="text-center mt-6">
              <button
                ...
                type="button"
              >
                <i className="flex fab fa-twitter text-purple-500 fa-2x"></i>
              </button>
              <button
                ...
                type="button"
              >
                <i className="flex fab fa-facebook-square text-purple-500 fa-2x"></i>
              </button>
              <button
                ...
                type="button"
              >
                <i className="flex fab fa-instagram text-purple-500 fa-2x"></i>
              </button>
            </div>
          </div>
        </div>
